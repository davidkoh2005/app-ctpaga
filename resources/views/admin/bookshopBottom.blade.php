<!--   Core JS Files   -->
  ...
  <!-- Chartist JS -->
  <script src="{{ asset('js/dashboard/plugins/chartist.js') }}"></script>
  <script src="{{ asset('js/dashboard/plugins/plugin-chartist.js') }}"></script>
  <!--  Notifications Plugin    -->
  <script src="{{ asset('js/dashboard/plugins/bootstrap-notify.js') }}"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{ asset('js/dashboard/material-dashboard.js?v=2.1.2') }}" type="text/javascript"></script>

  <script src="{{ asset('js/dashboard/script.js') }}" type="text/javascript"></script>
  <script src="{{ asset('js/dashboard/menu.js') }}" type="text/javascript"></script>