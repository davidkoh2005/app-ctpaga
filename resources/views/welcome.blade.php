    ...
    <body>
            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-md-6 col-sm-12 col-12">
                        <div class="present">
                            <h1> Ctapaga permite pagar productos y/o servicios desde la comodidad de tu casa</h1>
                            
                            <h5> Disponible en <span> App Store </span> y <b> Play Store</b> </h5>
        ...
        <section class="primary-bg">
            <div class="container">
                ...
                <div class="col-md-6 col-sm-12 col-12">
                    <div class="download">
                        <h3> Descargar la aplicación ahora</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="footer_top">
                            <h4> Comparte tus aplicaciones móviles favoritas con tus amigos  </h4>
