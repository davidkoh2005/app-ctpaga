            ...
            <header class="navbar navbar-sticky navbar-expand-lg navbar-dark">
                <div class="container position-relative">
                    <a class="navbar-brand" href="{{route('welcome')}}">
                        <img class="navbar-brand-regular" src="../../images/logo/logoWhite.png" width="180px" alt="brand-logo">
                        <img class="navbar-brand-sticky" src="../../images/logo/logoWhite.png" width="180px" alt="sticky brand-logo">
                    </a>
