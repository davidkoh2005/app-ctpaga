...
<body>
    <table style="width: 100%; padding: 10px; margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td
                ...
                <div
                    ...
                    <h2 style="color:#59595e; margin: 0 0 7px; text-transform: uppercase; font-size: 15px; text-align: center;">USUARIO
                        PAUSADO</h2>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td style="background-color: #fff; font-size: 16px">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: left; font-family: sans-serif;">
                    <p style="color:#59595e; margin: 0 0 7px;">Estimado/a <strong>{{strtoupper($user->name)}}</strong></p><br><br>
        ...
        <tr>
            <td style="background-color: #fff; text-align: left; padding: 0;"><br>
