    ...
    <table style="width: 100%; padding: 10px; margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td style="background-color: #fff; text-align: left; padding: 0;">
                <br>
                <a href="">
                    <img src="{{ asset('images/email/1.png').'?v='.time() }}" alt=""
        ...
        <tr>
            <td style="background-color: #fff; font-size: 16px">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: left; font-family: sans-serif;">
                    ...
                    <br>
                    <br>
                    <p style="color:#59595e; margin: 0 0 7px;">{{env('APP_NAME')}} Delivery le informa que el pedido con el Nro {{$paid->codeUrl}} , el cual será despachado en aproximadamente 1 hora.
                    </p>
                    ...
                    <br>
                    <p style="color:#59595e; margin: 0 0 7px;">Por favor seleccione el siguiente
                    enlace para ver los detalles de delivery
                    <strong>
                        <a href="{{$url}}">{{$url}} </a>
                    </strong> </p>
                    <br>
