            ...
            <td
                ...
                <div
                    ...
                    <h2 style="color:#59595e; margin: 0 0 7px; text-transform: uppercase; font-size: 15px; text-align: center;">CONFIRMACIÓN
                        DE REGISTRO EN <br> SU PUNTO DE VENTA</h2>
                </div>
            </td>
        </tr>
        <tr>
            <td style="background-color: #fff; text-align: left; padding: 0;"><br><a href=""><img
                        src="{{ asset('images/email/2.png').'?v='.time() }}" alt=""
        ...
        <tr>
            <td style="background-color: #fff; font-size: 16px">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: left; font-family: sans-serif;">
                    ...
                    <br>
                    <br>
                    <p style="color:#59595e; margin: 0 0 7px;">Estamos encantados de notificarle que ha completado
                        satisfactoriamente los datos Bancarios en su totalidad, por lo que su cuenta se ha CONFIRMADO
                        con Éxito.</p><br>
