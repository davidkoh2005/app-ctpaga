...
<body>
    <table style="width: 100%; padding: 10px; margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td
                ...
                <div
                    ...
                    <h2 style="color:#59595e; margin: 0 0 7px; text-transform: uppercase; font-size: 15px; text-align: center;">CUENTA
                        RECHAZADA</h2>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td style="background-color: #fff; font-size: 16px">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: left; font-family: sans-serif;">
                    ...
                    <br><br>
                    <p style="color:#59595e; margin: 0 0 7px;">Después de revisar exhaustivamente la información
                        proporcionada por usted, lamentamos informarle que debemos RECHAZAR su solicitud, las leyes no
                        nos obligan a informarle la razón de nuestra decisión, por lo que nos reservamos dicha
                        información.
                    </p>
                    <br><br><br>
                    <p style="color:#59595e; margin: 0 0 7px;">Muchas gracias.</p>
                    <h4 style="color:#59595e; margin: 0 0 7px;">El equipo de {{env('APP_NAME')}}.</h4>
                    <br><br><br><br>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td style="background-color: #fff; text-align: left; padding: 0;"><br><br>
                <div style="width: 100%; height: 40px; background: #E4E4E4;"></div>
            </td>
        </tr>
    </table>
</body>
