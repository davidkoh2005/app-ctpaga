    ...
    <table style="width: 100%; padding: 10px; margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td style="background-color: #fff; text-align: left; padding: 0;">
                <br>
                <a href="">
                    <img src="{{ asset('images/email/12.png').'?v='.time() }}" alt=""
        ...
        <tr>
            <td style="background-color: #fff; font-size: 16px">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: left; font-family: sans-serif;">
                    ...
                    <br>
                    <br>
                    <p style="color:#59595e; margin: 0 0 7px;">Hemos enviado los fondos que tenía en su cartera por
                        Concepto de Ventas de Productos y/o Servicios, a la cuenta proporcionada por Ud. en el módulo de
                        Bancos.
                    </p>
                    <br>
                    <br>
                    ...
                    <p style="color:#59595e; margin: 0 0 7px;"> <strong>Num de Referencia:</strong> {{$deposits->numRef}}</p>
                    <br>
                    <br>
